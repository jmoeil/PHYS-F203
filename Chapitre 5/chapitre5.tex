...
% $|\gamma_\mathrm{I}(t)|^2 +|\gamma_\mathrm{II}(t)|^2 = 1$ pour tout temps $t$, ça c'est normal. Mais le prof il donne comme exemple : 
% $$\boxed{\gamma_\mathrm{I}(-\infty) = 1 \qquad \gamma_\mathrm{II}(-\infty) = 0}$$
% et pour moi ça veut rien dire parce que les "infinis sont différents" haha \\

% Par contre, écrire $$\lim_{t\rightarrow -\infty}\gamma_\mathrm{I}(t) = 1 \qquad \lim_{t\rightarrow -\infty}\gamma_\mathrm{II}(t) = 0$$
% ça ça me parle plus, parce qu'une limite a une "unique" valeur (pour autant qu'elle soit définie)
