...
\bg{Remarque : les états quantiques}{Qu'entend-on par \textbf{état quantique} ? De manière plus générale, on peut définir un état, en physique, par l'ensemble des aspects qui caractérisent un système, de sorte à ce que l'on puisse prévoir les résultats d'une expérience, d'une mesure sur ce système. \\
...
\bg{Remarque : }{\begin{itemize}[label = \textbullet]
