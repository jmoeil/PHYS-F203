...
\newpage
\textbf{Avertissement.} Dans le cadre de ce document, nous employons le symbole $\doteq$ comme signifiant "par définition". Les vecteurs seront indiqués en gras : $\vec{x} = \bm{x}$.
\tableofcontents
