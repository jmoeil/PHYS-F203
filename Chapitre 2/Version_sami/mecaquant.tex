...
\begin{equation} \label{eq:ch2-correspondance}
  ...
  \end{array}}
  \end{equation}
{\color{blue}{Je trouve le paragraphe un peu long. Voici ce que je propose à la place : Afin de décrire notre système quantique, nous allons utiliser une équation représentant son énergie, dans lequel nous pourrons exploiter les relations d'équivalence \ref{équivalence pulsation} et \ref{equivalence nombre d'onde} obtenues précédemment. 
